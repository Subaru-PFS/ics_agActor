...
class opDB:
    ...
    def query_agc_exposure(frame_id):
        ...
        with opDB._connect() as c:
            ...
            return (*data[:2], datetime.datetime.strptime(data[2], opDB._DATETIME_FORMAT), *data[3:-1], m2_pos3)
