...
_DXDP = (
    -np.array([+0.405, +0.055, +0.357, -0.270, -0.444, -0.067])
...
_DYDP = (
    -np.array([-0.668, +0.081, +0.180, +0.357, +0.138, -0.077])
...
_DTDP = (
    np.array([-0.253368, +0.234505, +0.329449, +0.416894, +0.0589071, +0.234977])
