...
if __name__ == "__main__":
    ...
    ###
    ###### telescope status
    ### DATE-OBS UT-STR RA2000 DEC2000 ADC-STR INR-STR
    ###
    ...
    tel_ra, tel_de, dt, adc, inr = popt2.telStatusfromText(telstat)

    ra_offset,de_offset,inr_offset = pfs.FA(stararray, agarray, tel_ra, tel_de, dt, adc, inr )
