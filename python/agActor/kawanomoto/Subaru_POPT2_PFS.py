...
class Subaru:
    ...
    def radec2radecplxpm(self, str_ra, str_de, str_plx, str_pmRA, str_pmDE, t):
        ...
        str_coord = SkyCoord(ra=str_ra * u.degree, dec=str_de * u.degree, distance=Distance(parallax=str_plx * u.mas, allow_negative=False), pm_ra_cosdec=str_pmRA * u.mas / u.yr, pm_dec=str_pmDE * u.mas / u.yr, obstime=Time(2015.5, format='decimalyear'), frame='icrs')
...
class POPT2:
    ...
    def telStatusfromText(self, textfile):
        array = np.loadtxt(textfile, dtype={'names': ('DATE-OBS', 'UT-STR', 'RA2000', 'DEC2000', 'ADC-STR', 'INR-STR', 'M2-POS3', 'WAVELEN'), 'formats': ('<U10', '<U12', '<U12', '<U12', '<U12', '<U12', '<U12', '<U12')})
    ...
    def celestial2focalplane_wisp(self, sep, zpa, adc, m2pos3, wl):
        ...
        cx2 = 2.62676925e02 + (-1.87221607e-06 + 2.92222089e-06 * D) * adc ** 2
        cx7 = 3.35307347e00 + (-7.81712660e-09 - 1.05819104e-09 * D) * adc ** 2
        ...
        cy3 = 2.62676925e02 + (-8.86455750e-06 + 3.15626958e-06 * D) * adc ** 2
        cy8 = 3.35307347e00 + (-6.26053110e-07 - 2.95393149e-07 * D) * adc ** 2
        ...
        telx = cx2 * (x) + cx7 * ((3 * (x ** 2 + y ** 2) - 2) * x) + cx14 * ((10 * (x ** 2 + y ** 2) ** 2 - 12 * (x ** 2 + y ** 2) + 3) * x) + cx23 * ((35 * (x ** 2 + y ** 2) ** 3 - 60 * (x ** 2 + y ** 2) ** 2 + 30 * (x ** 2 + y ** 2) - 4) * x) + cx34 * ((126 * (x ** 2 + y ** 2) ** 4 - 280 * (x ** 2 + y ** 2) ** 3 + 210 * (x ** 2 + y ** 2) ** 2 - 60 * (x ** 2 + y ** 2) + 5) * x) + cx47 * ((462 * (x ** 2 + y ** 2) ** 5 - 1260 * (x ** 2 + y ** 2) ** 4 + 1260 * (x ** 2 + y ** 2) ** 3 - 560 * (x ** 2 + y ** 2) ** 2 + 105 * (x ** 2 + y ** 2) - 6) * x) + cx6 * (2 * x * y) + cx13 * ((4 * (x ** 2 + y ** 2) - 3) * 2 * x * y) + cx1 * (1) + cx4 * (2 * (x ** 2 + y ** 2) - 1) + cx9 * ((6 * (x ** 2 + y ** 2) ** 2 - 6 * (x ** 2 + y ** 2) + 1))

        tely = cy3 * (y) + cy8 * ((3 * (x ** 2 + y ** 2) - 2) * y) + cy15 * ((10 * (x ** 2 + y ** 2) ** 2 - 12 * (x ** 2 + y ** 2) + 3) * y) + cy24 * ((35 * (x ** 2 + y ** 2) ** 3 - 60 * (x ** 2 + y ** 2) ** 2 + 30 * (x ** 2 + y ** 2) - 4) * y) + cy35 * ((126 * (x ** 2 + y ** 2) ** 4 - 280 * (x ** 2 + y ** 2) ** 3 + 210 * (x ** 2 + y ** 2) ** 2 - 60 * (x ** 2 + y ** 2) + 5) * y) + cy48 * ((462 * (x ** 2 + y ** 2) ** 5 - 1260 * (x ** 2 + y ** 2) ** 4 + 1260 * (x ** 2 + y ** 2) ** 3 - 560 * (x ** 2 + y ** 2) ** 2 + 105 * (x ** 2 + y ** 2) - 6) * y) + cy5 * (x ** 2 - y ** 2) + cy12 * ((4 * (x ** 2 + y ** 2) - 3) * (x ** 2 - y ** 2)) + cy1 * (1) + cy4 * (2 * (x ** 2 + y ** 2) - 1) + cy9 * ((6 * (x ** 2 + y ** 2) ** 2 - 6 * (x ** 2 + y ** 2) + 1))
    ...
    def focalplane2celestial_wisp(self, xt, yt, adc, m2pos3, wl):
        ...
        cx2 = 1.43733003e-02 + (8.72090395e-11 + 0.00000000e00 * D) * adc ** 2
        ...
        cy3 = 1.43733003e-02 + (4.61943503e-10 + 0.00000000e00 * D) * adc ** 2
        ...
        tantx = cx2 * (x) + cx7 * ((3 * (x ** 2 + y ** 2) - 2) * x) + cx14 * ((10 * (x ** 2 + y ** 2) ** 2 - 12 * (x ** 2 + y ** 2) + 3) * x) + cx23 * ((35 * (x ** 2 + y ** 2) ** 3 - 60 * (x ** 2 + y ** 2) ** 2 + 30 * (x ** 2 + y ** 2) - 4) * x) + cx34 * ((126 * (x ** 2 + y ** 2) ** 4 - 280 * (x ** 2 + y ** 2) ** 3 + 210 * (x ** 2 + y ** 2) ** 2 - 60 * (x ** 2 + y ** 2) + 5) * x) + cx47 * ((462 * (x ** 2 + y ** 2) ** 5 - 1260 * (x ** 2 + y ** 2) ** 4 + 1260 * (x ** 2 + y ** 2) ** 3 - 560 * (x ** 2 + y ** 2) ** 2 + 105 * (x ** 2 + y ** 2) - 6) * x) + cx6 * (2 * x * y) + cx13 * ((4 * (x ** 2 + y ** 2) - 3) * 2 * x * y) + cx1 * (1) + cx4 * (2 * (x ** 2 + y ** 2) - 1) + cx9 * ((6 * (x ** 2 + y ** 2) ** 2 - 6 * (x ** 2 + y ** 2) + 1))

        tanty = cy3 * (y) + cy8 * ((3 * (x ** 2 + y ** 2) - 2) * y) + cy15 * ((10 * (x ** 2 + y ** 2) ** 2 - 12 * (x ** 2 + y ** 2) + 3) * y) + cy24 * ((35 * (x ** 2 + y ** 2) ** 3 - 60 * (x ** 2 + y ** 2) ** 2 + 30 * (x ** 2 + y ** 2) - 4) * y) + cy35 * ((126 * (x ** 2 + y ** 2) ** 4 - 280 * (x ** 2 + y ** 2) ** 3 + 210 * (x ** 2 + y ** 2) ** 2 - 60 * (x ** 2 + y ** 2) + 5) * y) + cy48 * ((462 * (x ** 2 + y ** 2) ** 5 - 1260 * (x ** 2 + y ** 2) ** 4 + 1260 * (x ** 2 + y ** 2) ** 3 - 560 * (x ** 2 + y ** 2) ** 2 + 105 * (x ** 2 + y ** 2) - 6) * y) + cy5 * (x ** 2 - y ** 2) + cy12 * ((4 * (x ** 2 + y ** 2) - 3) * (x ** 2 - y ** 2)) + cy1 * (1) + cy4 * (2 * (x ** 2 + y ** 2) - 1) + cy9 * ((6 * (x ** 2 + y ** 2) ** 2 - 6 * (x ** 2 + y ** 2) + 1))
    ...
    def celestial2focalplane_wosp(self, sep, zpa, adc, m2pos3, wl):
        ...
        cx2 = 2.62647800e02 + (-1.87011330e-06 + 2.77589523e-06 * D) * adc ** 2
        cx7 = 3.35086900e00 + (-7.57865771e-09 + 5.53973051e-08 * D) * adc ** 2
        ...
        cy3 = 2.62647800e02 + (-8.86916339e-06 + 3.23008109e-06 * D) * adc ** 2
        cy8 = 3.35086900e00 + (-6.08839423e-07 - 5.65253675e-07 * D) * adc ** 2
    ...
    def RADECInRShift(self, obj_xdp, obj_ydp, obj_int, cat_xdp, cat_ydp, cat_mag, dxra, dyra, dxde, dyde, dxinr, dyinr):
...
class PFS:
    ...
    def agarray2momentdifference(self, array, maxellip, maxsize, minsize):
        ...
        filtered_agarray, _ = POPT2.sourceFilter(self, array, maxellip, maxsize, minsize)
