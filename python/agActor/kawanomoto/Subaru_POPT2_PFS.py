...
class Subaru():
    def radec2inr(self, tel_ra, tel_de, t):
        ...
        np_coord = ac.SkyCoord(
            ra=0.0, dec=90.0, unit=(au.deg, au.deg), frame='fk5', equinox=t
            )  # north pole at observing time
        frame_subaru = ac.AltAz(
            obstime=t, location=Lsbr, \
    ...
    def radec2radecplxpm(self, gaia_epoch, str_ra, str_de, str_plx, str_pmRA, str_pmDE, t):
        ...
        str_coord = ac.SkyCoord(
            ra=tmp_coord2.ra, dec=tmp_coord2.dec, unit=(au.deg, au.deg),
...
class POPT2():
    ...
    def coeffs_COBRA_c2f(self, wl, adc):  # celestial to focal plane for COBRA
        ...
        cx[0] = (+2.62789699e+02) + (+1.41436855e-02 * L) + (+6.58982982e-03 * L ** 2) + (-9.48051092e-03 * L ** 3) + (
                -1.00694635e-06 + (-2.48248836e-05 * D)) * adc ** 2
        cx[1] = (+3.36215747e+00) + (+3.69187393e-03 * L) + (-6.74817524e-03 * L ** 2) + (+1.54801942e-03 * L ** 3) + (
                +7.61247574e-09 + (-6.33418826e-07 * D)) * adc ** 2
        cx[2] = (+2.35198776e-01) + (+9.42825888e-04 * L) + (+9.90958196e-04 * L ** 2) + (-3.17796838e-05 * L ** 3) + (
                +1.42425375e-08 + (-1.72148497e-06 * D)) * adc ** 2
        cx[3] = (+1.46655737e-02) + (-1.79003541e-03 * L) + (-1.55308635e-03 * L ** 2) + (+1.13125337e-03 * L ** 3) + (
                +2.15230267e-08 + (-1.40990705e-06 * D)) * adc ** 2
        cx[4] = (-5.52214359e-03) + (-6.97491826e-04 * L) + (-9.14390111e-04 * L ** 2) + (+5.80494577e-04 * L ** 3) + (
                -7.18716293e-09 + (-1.08374155e-06 * D)) * adc ** 2
        cx[5] = (+2.71674871e-03) + (+1.09560963e-03 * L) + (+4.82675939e-04 * L ** 2) + (-1.53464406e-04 * L ** 3) + (
                -1.67044496e-08 + (+5.65443437e-07 * D)) * adc ** 2
        ...
        cy[0] = (+2.62789699e+02) + (+1.41436855e-02 * L) + (+6.58982982e-03 * L ** 2) + (-9.48051092e-03 * L ** 3) + (
                -4.18883241e-06 + (-1.47780317e-04 * D)) * adc ** 2
        cy[1] = (+3.36215747e+00) + (+3.69187393e-03 * L) + (-6.74817524e-03 * L ** 2) + (+1.54801942e-03 * L ** 3) + (
                -3.63808492e-07 + (-9.59230438e-06 * D)) * adc ** 2
        cy[2] = (+2.35198776e-01) + (+9.42825888e-04 * L) + (+9.90958196e-04 * L ** 2) + (-3.17796838e-05 * L ** 3) + (
                -2.93764283e-08 + (-4.75333128e-06 * D)) * adc ** 2
        cy[3] = (+1.46655737e-02) + (-1.79003541e-03 * L) + (-1.55308635e-03 * L ** 2) + (+1.13125337e-03 * L ** 3) + (
                +8.30835081e-08 + (-8.68707778e-06 * D)) * adc ** 2
        cy[4] = (-5.52214359e-03) + (-6.97491826e-04 * L) + (-9.14390111e-04 * L ** 2) + (+5.80494577e-04 * L ** 3) + (
                +2.58088187e-08 + (-4.49063408e-06 * D)) * adc ** 2
        cy[5] = (+2.71674871e-03) + (+1.09560963e-03 * L) + (+4.82675939e-04 * L ** 2) + (-1.53464406e-04 * L ** 3) + (
                -3.73048239e-08 + (+2.68719899e-06 * D)) * adc ** 2
    ...
    def coeffs_COBRA_f2c(self, wl, adc):  # focal plane to celestial for COBRA
        ...
        cx[0] = (1.43674845e-02) + (-7.43646874e-07 * L) + (-3.16130067e-07 * L ** 2) + (4.80328267e-07 * L ** 3) + (
                5.05131730e-11 + (1.17283146e-09 * D)) * adc ** 2
        cx[1] = (-1.88289474e-04) + (-1.56460268e-07 * L) + (3.80620067e-07 * L ** 2) + (-1.19205317e-07 * L ** 3) + (
                -4.84876314e-12 + (-7.61093281e-11 * D)) * adc ** 2
        cx[2] = (-6.46172751e-06) + (-2.66777511e-08 * L) + (-6.33815835e-08 * L ** 2) + (-7.74745171e-09 * L ** 3) + (
                -9.62743893e-13 + (9.64732206e-11 * D)) * adc ** 2
        cx[3] = (1.23562185e-07) + (9.24192386e-08 * L) + (9.39175516e-08 * L ** 2) + (-6.74785592e-08 * L ** 3) + (
                -6.67748446e-13 + (6.60925128e-11 * D)) * adc ** 2
        cx[4] = (3.68389899e-07) + (1.03386621e-08 * L) + (3.47784649e-08 * L ** 2) + (-2.36730251e-08 * L ** 3) + (
                1.08679636e-12 + (2.43537188e-11 * D)) * adc ** 2
        cx[5] = (-1.63142810e-07) + (-4.53025978e-08 * L) + (-2.49134365e-08 * L ** 2) + (1.03064829e-08 * L ** 3) + (
                4.18052943e-13 + (-3.13541684e-11 * D)) * adc ** 2
        ...
        cy[0] = (1.43674845e-02) + (-7.43646874e-07 * L) + (-3.16130067e-07 * L ** 2) + (4.80328267e-07 * L ** 3) + (
                2.20715956e-10 + (7.77431541e-09 * D)) * adc ** 2
        cy[1] = (-1.88289474e-04) + (-1.56460268e-07 * L) + (3.80620067e-07 * L ** 2) + (-1.19205317e-07 * L ** 3) + (
                8.06546205e-12 + (1.99216576e-10 * D)) * adc ** 2
        cy[2] = (-6.46172751e-06) + (-2.66777511e-08 * L) + (-6.33815835e-08 * L ** 2) + (-7.74745171e-09 * L ** 3) + (
                -6.15086757e-13 + (2.97964659e-10 * D)) * adc ** 2
        cy[3] = (1.23562185e-07) + (9.24192386e-08 * L) + (9.39175516e-08 * L ** 2) + (-6.74785592e-08 * L ** 3) + (
                -4.06656270e-12 + (4.65768165e-10 * D)) * adc ** 2
        cy[4] = (3.68389899e-07) + (1.03386621e-08 * L) + (3.47784649e-08 * L ** 2) + (-2.36730251e-08 * L ** 3) + (
                5.85562680e-13 + (1.36403403e-10 * D)) * adc ** 2
        cy[5] = (-1.63142810e-07) + (-4.53025978e-08 * L) + (-2.49134365e-08 * L ** 2) + (1.03064829e-08 * L ** 3) + (
                1.38694343e-12 + (-1.22884800e-10 * D)) * adc ** 2
    ...
    def ZX(self, x, y, cx):
        return \
                ...
                cx[3] * ((35 * (x ** 2 + y ** 2) ** 3 - 60 * (x ** 2 + y ** 2) ** 2 + 30 * (x ** 2 + y ** 2) - 4) *
                         x) + \
                cx[4] * ((126 * (x ** 2 + y ** 2) ** 4 - 280 * (x ** 2 + y ** 2) ** 3 + 210 * (
                    x ** 2 + y ** 2) ** 2 - 60 * (x ** 2 + y ** 2) + 5) * x) + \
                cx[5] * ((462 * (x ** 2 + y ** 2) ** 5 - 1260 * (x ** 2 + y ** 2) ** 4 + 1260 * (
                    x ** 2 + y ** 2) ** 3 - 560 * (x ** 2 + y ** 2) ** 2 + 105 * (x ** 2 + y ** 2) - 6) * x) + \
                cx[6] * (2 * x * y) + \
    ...
    def ZY(self, x, y, cy):
        return \
                ...
                cy[3] * ((35 * (x ** 2 + y ** 2) ** 3 - 60 * (x ** 2 + y ** 2) ** 2 + 30 * (x ** 2 + y ** 2) - 4) *
                         y) + \
                cy[4] * ((126 * (x ** 2 + y ** 2) ** 4 - 280 * (x ** 2 + y ** 2) ** 3 + 210 * (
                    x ** 2 + y ** 2) ** 2 - 60 * (x ** 2 + y ** 2) + 5) * y) + \
                cy[5] * ((462 * (x ** 2 + y ** 2) ** 5 - 1260 * (x ** 2 + y ** 2) ** 4 + 1260 * (
                    x ** 2 + y ** 2) ** 3 - 560 * (x ** 2 + y ** 2) ** 2 + 105 * (x ** 2 + y ** 2) - 6) * y) + \
                cy[6] * (x ** 2 - y ** 2) + \
...
class distCorr():
    ...
    def xy2dxdy(self, xt, yt):
        ...
        x = xt / 270.0
        y = yt / 270.0
        ox = z0x + z1x * y + z2x * x + z3x * 2 * x * y + z4x * (2 * (x ** 2 + y ** 2) - 1) + z5x * (
                x ** 2 - y ** 2) + z6x * (3 * (x ** 2 + y ** 2) - 4 * y ** 2) * y + z7x * (
                     3 * (x ** 2 + y ** 2) - 2) * y + z8x * (3 * (x ** 2 + y ** 2) - 2) * x + z9x * (
                     -3 * (x ** 2 + y ** 2) + 4 * x ** 2) * x + z12x * (
                     6 * (x ** 2 + y ** 2) ** 2 - 6 * (x ** 2 + y ** 2) + 1)
        oy = z0y + z1y * y + z2y * x + z3y * 2 * x * y + z4y * (2 * (x ** 2 + y ** 2) - 1) + z5y * (
                x ** 2 - y ** 2) + z6y * (3 * (x ** 2 + y ** 2) - 4 * y ** 2) * y + z7y * (
                     3 * (x ** 2 + y ** 2) - 2) * y + z8y * (3 * (x ** 2 + y ** 2) - 2) * x + z9y * (
                     -3 * (x ** 2 + y ** 2) + 4 * x ** 2) * x + z12y * (
                     6 * (x ** 2 + y ** 2) ** 2 - 6 * (x ** 2 + y ** 2) + 1)
